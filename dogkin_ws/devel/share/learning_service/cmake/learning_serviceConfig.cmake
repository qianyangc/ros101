...
if("TRUE" STREQUAL "TRUE")
  set(learning_service_SOURCE_PREFIX /home/ubuntu/dogkin_ws/src/learning_service)
  set(learning_service_DEVEL_PREFIX /home/ubuntu/dogkin_ws/devel)
  ...
  set(learning_service_INSTALL_PREFIX /home/ubuntu/dogkin_ws/install)
...
if(NOT "/home/ubuntu/dogkin_ws/devel/include " STREQUAL " ")
  set(learning_service_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/dogkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'learning_service' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/dogkin_ws/src/learning_service/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/dogkin_ws/devel/lib;/home/ubuntu/dogkin_ws/devel/lib;/opt/ros/kinetic/lib)
